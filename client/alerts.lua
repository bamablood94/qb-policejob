...
RegisterNetEvent('qb-police:client:send:alert:panic:button2')
AddEventHandler('qb-police:client:send:alert:panic:button2', function(Coords, StreetName, Info)
...
-- RegisterNetEvent('qb-police:client:send:alert:atm')
-- AddEventHandler('qb-police:client:send:alert:atm', function(streetName, CCTV)
--  if (QBCore.Functions.GetPlayerData().job.name == "police") and QBCore.Functions.GetPlayerData().job.onduty then 
--     TriggerEvent('qb-alerts:client:send:alert', {
--         timeOut = 15000,
